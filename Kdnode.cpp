...
bool KDNode::boxTriangleIntersectionTest(const Vec3Df &A, const Vec3Df &B, const Vec3Df &C, BoundingBox box){
    ...
    p0 = -e0[2]*v1[0] + e0[0]*v1[2];

    p2 = -e0[2]*v3[0] + e0[0]*v3[2];
    ...
    p1 = e0[1]*v2[0] - e0[0]*v2[1];

    p2 = e0[1]*v3[0] - e0[0]*v3[1];
    ...
    p0 = -e1[2]*v1[0] + e1[0]*v1[2];

    p2 = -e1[2]*v3[0] + e1[0]*v3[2];
    ...
    p1 = e2[1]*v2[0] - e2[0]*v2[1];

    p2 = e2[1]*v3[0] - e2[0]*v3[1];
